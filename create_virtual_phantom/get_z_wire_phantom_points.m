function z_wire_phantom_points = get_z_wire_phantom_points(start_at_000, home_path)
...
%       
   ...
   writematrix(z_wire_phantom_points, fullfile(home_path,'create_virtual_phantom\wire_phantom.csv'));
end
