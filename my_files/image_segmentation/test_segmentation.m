...
Threshold = 0.3;
%%
filename = 'gama_positive (21)';
path_to_save = 'D:\SEM_4\Project\my_files\image_segmentation\raw_images\try_2\gama_positive';
...
% IN_IMG_median_filter_1 = IN_IMG_median_filter(1:1500,:);
% IN_IMG_median_filter_2= IN_IMG_median_filter(1500:end,:);
% 
% figure;
...
% %% Binary image
% % 
% BW_1 = imbinarize(IN_IMG_median_filter_1,0.3);
% BW_1(150:300 ,:) = 0;
% BW_1(1150:end ,:) = 0;
% BW_1(650:1000 ,:) = 0;
% SE = strel('disk',8);
